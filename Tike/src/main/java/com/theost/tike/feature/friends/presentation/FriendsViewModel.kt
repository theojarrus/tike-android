...
import com.theost.tike.feature.friends.business.ObserveFriendsInteractor

class FriendsViewModel : BaseStateViewModel<FriendsState>(), SearchViewModel {

    private val mapper = UserUiMapper()

    private val observeFriendsInteractor = ObserveFriendsInteractor(
        AuthRepository,
        UsersRepository,
        mapper
    )
