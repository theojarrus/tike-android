package com.theost.tike.feature.joining.ui
...
import com.theost.tike.feature.creation.ui.AddingFragmentDirections.Companion.actionAddingFragmentToCreatorFragment
import com.theost.tike.feature.creation.ui.AddingFragmentDirections.Companion.actionAddingFragmentToInfoFragment
import com.theost.tike.feature.joining.presentation.JoiningViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.eventsList.adapter = adapter.apply {
            addDelegate(EventAdapterDelegate { action ->
                when (action) {
                    is Accept -> showConfirmationDialog(
                        requireContext(),
        ...
        viewModel.creator.observe(viewLifecycleOwner) { user ->
            with(binding) {
                ...
                creatorView.apply {
                    ...
                    when {
                        user?.avatar != null && user.hasAccess -> avatar.loadWithPlaceholder(user.avatar, R.color.blue)
